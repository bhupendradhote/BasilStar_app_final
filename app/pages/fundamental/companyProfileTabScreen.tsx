...
export default function CompanyProfileTabScreen({ symbol }: Props) {
  ...
  if (loading) return <ActivityIndicator size="large" color="#123530" style={{ marginTop: 50 }} />;
  if (!profile) return <Text style={styles.empty}>No company profile available.</Text>;
