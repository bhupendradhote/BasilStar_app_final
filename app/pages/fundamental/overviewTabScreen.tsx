...
export default function OverviewTabScreen({ symbol }: Props) {
  ...
  if (loading) return <ActivityIndicator size="large" color="#123530" />;
  if (!data.length || !quote) return <Text style={styles.empty}>No data available.</Text>;
...
const styles = StyleSheet.create({
  ...
  quoteRow: { flexDirection: "row", justifyContent: "space-between", paddingVertical: 8, borderBottomWidth: 0.5, borderBottomColor: "#ccc" },
  quoteLabel: { fontSize: 14, fontWeight: "500", paddingVertical: 4 },
  quoteValue: { fontSize: 14, fontWeight: "600", paddingVertical: 4 },
  historyContainer: { marginTop: 20, padding: 12, borderRadius: 12, backgroundColor: "#fafafa" },
  historyTitle: { fontSize: 16, fontWeight: "600", marginBottom: 8 },
  historyRow: { marginBottom: 8, paddingVertical: 4, borderBottomWidth: 0.5, borderBottomColor: "#ddd" },
  ...
  sentimentContainer: { marginTop: 20, padding: 12, borderRadius: 12, backgroundColor: "#e6f7ff" },
